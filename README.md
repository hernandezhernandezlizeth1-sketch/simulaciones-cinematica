...
- **Render GIF:** Ejecuta `python cinematica_punto/generar_video.py`
...
- **Interactivo:** Ejecuta `python movimiento_rectilineo/main.py`
- **Render GIF:** Ejecuta `python movimiento_rectilineo/generar_video.py`
...
- **Render GIF:** Ejecuta `python cuerpo_rigido/generar_video.py`
...
Abrir una terminal(CMD) y ejecutar el siguiente comando en la carpeta donde lo vas a descargar. 
Ejemplo:
```bash
cd documents
```
